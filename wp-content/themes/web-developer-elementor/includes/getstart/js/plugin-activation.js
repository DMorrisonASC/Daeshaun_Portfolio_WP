jQuery(document).ready(function($) {
    'use strict';
    var this_obj = web_developer_elementor_plugin_activate_plugin;

    $('#wpelemento_importer_editor .plugin-activation-redirect a').addClass('wpi-redirect-to-dashboard');

    $(document).on('click', '.web-developer-elementor-plugin-install', function(event) {
        ...
        wp.updates.installPlugin({
            ...
            success: function(data) {
                ...
                button.removeClass('button-secondary updating-message web-developer-elementor-plugin-install');
                button.addClass('button-primary web-developer-elementor-plugin-activate');
                button.trigger('click');
            },
            error: function(data) {
                jQuery('.web-developer-elementor-recommended-plugins .web-developer-elementor-activation-note').css('display','block');
    ...
    $(document).on('click', '.web-developer-elementor-plugin-activate', function(event) {
